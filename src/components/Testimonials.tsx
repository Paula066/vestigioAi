...
const Testimonial: React.FC<TestimonialProps> = ({ text, author, position, company, img }) => (
  <div className="flex flex-col p-4 md:p-6 bg-black/30 rounded-2xl backdrop-blur-sm">
    ...
    <div className="flex items-center gap-3 md:gap-4">
      <div className="w-[40px] h-[40px] md:w-[47px] md:h-[47px] rounded-full relative">
      ...
      <div>
        <div className="text-white text-[16px] md:text-[18px] font-light">{author}</div>
        <div className="text-[#72787E] text-[14px] md:text-[16px]">{position}</div>
      </div>
    </div>
  </div>
);
  ...
  return (
    <section className="py-12 md:py-24 bg-black">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="text-white text-[32px] md:text-[44px] font-light leading-[42px] md:leading-[57px] mb-8 md:mb-16 text-center md:text-left">
