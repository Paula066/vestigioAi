        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0">
            <div className="text-center md:text-left">
              ...
              <div className="mt-[32px] md:mt-[48px]">
                <Link
                  to="/oferta"
                  className="inline-block rounded-full px-[32px] md:px-[48px] py-3 text-base font-light text-black hover:opacity-90 transition-opacity bg-gradient-to-r from-[#FFE4D6] to-[#D5BBF9]"
                >
